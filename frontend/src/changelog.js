...
export const CHANGELOG = [
  ...
  },
  {
    ...
    date: "2026-08-20",
    changes: [
      "🧭 Active renders now remain visible in History when you begin another video.",
      "✨ Studio owners can run full AI-scene demonstrations without customer plan limits interrupting submission.",
      "🎨 Clarified AI visual choices so the recommended image-quality path is easier to identify.",
    ],
  },
  {
    version: "1.20.14",
    date: "2026-08-18",
    changes: [
      "✨ Improved AI-generated scene image quality while keeping a reliable fallback if generation is temporarily unavailable.",
      "🎞️ Customer-uploaded images, videos, and screen recordings remain on the local B-roll path without being sent for additional visual generation.",
    ],
  },
  {
    version: "1.20.13",
